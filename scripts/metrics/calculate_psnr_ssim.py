...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/data/dl/SRDenseNet-pytorch-master-yjn870/newdatasets/test_all/Bachang_Seq_9_test/HR', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/data/dl/SRDenseNet-pytorch-master-yjn870/results_Bachang_Seq_9', help='Path to restored images')
    ...
    # args = parser.parse_args(['--test_y_channel'])
